...
class DoublyLinkedList:
    ...
    def add_to_tail(self, value):
        ...
        if not self.head and not self.tail:
            ...
            # reassign self.tail to point to the new node
            self.tail = new_node
    ...
    def move_to_front(self, node):
        ...
        if node is self.head:
            return None
        # store reference to node to move
        value = node.value
    ...
    def delete(self, node):
        ...
        # check if the node is the tail
            ...
            self.tail = node.prev
            node.delete()
        # else, there's no reference to update
        else:
            node.delete()
    ...
    def get_max(self):
        # variable to keep track of largest element
